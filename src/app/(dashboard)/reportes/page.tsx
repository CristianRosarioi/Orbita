...
const REPORTES = [
  {
    ...
    descripcion: 'Ventas a clientes: NCF, montos, ITBIS facturado y tipo de comprobante por período mensual.',
    disponible: true,
  },
  {
    href: '/reportes/607',
    ...
    descripcion: 'Compras a proveedores con NCF, disponible cuando se implemente el módulo de compras (Fase 6).',
    disponible: false,
  },
  {
    href: '/reportes/608',
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 flex items-start gap-3">
        ...
        <p className="text-sm text-amber-800">
          Las empresas en <strong>Modo Simple</strong> generan reportes referenciales. Para validez fiscal ante la DGII
          activa el Modo Fiscal en Configuración.
        </p>
      </div>

      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        {REPORTES.map((r) => (
          <Card key={r.href} className={`relative ${!r.disponible ? 'opacity-70' : 'hover:shadow-md transition-shadow'}`}>
